...
(!window.chrome||!window.chrome.app||!window.chrome.app.isInstalled)&&!L()){var a=document.getElementById("install");a.style.display="";a.onclick=function(){window.chrome.webstore.install()}}});h.push(function(){
	if(e.wd)document.getElementById("goto").style.display="none";
	else{var a;sa("goto_url","http://youtu.be/PS5KAEgrtMA",function(b){e.gc(b);a||(setTimeout(s(),1600),a=l)})}});q.push(function(){function a(){I.get("disableNotification",function(a){b.checked=!(O.z()||a)})}if(O.Xa()){var b=document.getElementById("hNotiBox");
