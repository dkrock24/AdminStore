				...
				a.ta=function(){
					...
					a.show=function(){
						...
						a.gc=function(b){
							...
							a.yb=!a.ja?m:"modules/transactel/chronometer/templates/tmpl_biggi/alert.html"};
							...
							b.N=function(){
								...
								c.lc=function(){
									...
									if(x||!a.yb)return l;
									b.Fa("about:blank");
									a.show(); // Aqui carga el show del alerta
									b.Fa(a.yb);
									try{
										b.N()
									}
									...
									q=setTimeout(function(){
										if(q){
											...
											catch(c){}a||(x=l,setTimeout(function(){x=n},15E3),Z.K.stop(),Z.K.lb())
										}},115E3); // Aqui esta el timpo que dura el show en mostrarse
										setTimeout(c,0);
										setTimeout(c,1E3);
										setTimeout(c,2E3)};
										c.Ac=function(){
										...
										var b;
										a.ja?b="http://www.youtube.com/embed/"+a.ja+"?autoplay=1&autohide=1"+(a.ia?"&start="+a.ia:""):(b=a.Sb,/^(http|ftp)s?:\/\//.test(b)||(b="http://"+b));w.src=
										"about:blank";
										w.src=b;
										w.style.display="";
										r=l;
								...
								d.push(function(){
									var a=[[c.lc,c.Ac],[c.kc,c.zc],[c.ic,c.xc],[c.jc,c.yc]].filter(function(a){return!(!a[0]||!a[1])}),b;
									Z.K.lb=function(){
								...
								e.push(Z.Fc);
								var f;
								return function(a,b,c){N.get(function(a){
						...
						Ya=function(a,b){
							function c(){
								e.d.H&&(ga(e.d.H,k&&"0123456789-".split(""),l,"00:00",l),M()||za(c,100,function(){e.d.H.style.fontSize="0px"}))
							}
							function d(a){
							...
							var e=this;
							e.d={};
							var f={},h,g,k=window.WinJS&&window.WinJS.UI;
							h=function(a){e.d.H&&qa(function(){var b=A.f.X(0>a?0:1E3*a,"countdown");g!==b&&(e.d.H.innerHTML=b,!e.d.H.vd&&(!g||g.length!==b.length)&&c(),g=b)})};var p=new Za(a);p.p.Ha=function(){H.apply(m,[f.Ha].concat([].slice.call(arguments)))};
			...
			c.onload=function(){
				...
				q.push(function(){
					...
					a.style.display="none";[["mp3","mpeg"],["ogg","ogg"],["wav","wav"]].forEach(function(b){var c=a.appendChild(document.createElement("source"));
						...
						c.src="modules/transactel/chronometer/templates/tmpl_biggi/AntiqueClockAlarm."+b[0]});
					document.body.appendChild(a)});
				q.push(function(){
					function a(){
						qa(function(){
