...
.A .B{
  ...
  <a href="#" id="../admin/Cpais/crear" class="btn btn-danger btn-crear" name="">Nuevo  Año</a><br>
    <div class="tab-pane fade active in" id="tab1_1">
      <form id="edit_estimado" method="post">
      <table class="table table-hover table-dynamic filter-head">
                    ...
                    <tbody>
                    <input type="hidden" value="<?php echo $data[0]->id; ?>" name="mes_id">
                    <?php
                    if($data !=""){
                    foreach ($data as $meses) {
                            ?>
                             <tr>
                                ...
                                <td>
                                    <a  class="detalle_pais" id="<?php echo $meses->id_mes; ?>" name='<?php echo $meses->id_mes; ?>' href="#">
                                    <button type="button" class="btn btn-primary btn-transparent">Guardar</button>
                                     </a>
                                </td>
