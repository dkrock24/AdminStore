...
<script>
 ...
 //-----------------Jquery insercion de  productos----------------
      ...
      //alert(formData);
        $.ajax
           ({
            url: "../sobras/Csobras/save_sobras_productos",
            type:"post",
   ...
   $("#ingrediente").autocomplete({
        source: "../sobras/Csobras/catalogo_materiales",
        minLength: 1
  });
//------------------END--------------------------------------------
      ...
      <div class="col-md-12">
              ...
              <div class="col-md-6">
                      <span class="input input--hoshi">
                          <input class="input__field input__field--hoshi" type="text" id="ingrediente" required name="ingrediente" placeholder="Escribir para buscar" />
                          <label class="input__label input__label--hoshi input__label--hoshi-color-1" for="input-4">
                          <span class="input__label-content">Producto</span>
                          </label>
                      </span>
               </div>     
                    ...
                    <div class="col-md-6">   
                       <span class="input input--hoshi">
                          <input class="input__field input__field--hoshi" type="number" id="cantidad" name="cantidad" required placeholder="cantida de producto" />
                          <label class="input__label input__label--hoshi input__label--hoshi-color-1" for="input-4">
