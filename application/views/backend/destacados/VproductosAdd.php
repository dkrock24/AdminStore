...
<script>
    ...
    $(".viewDetalle").click(function()
    {
        ...
        var prodcutoID = $(this).find('.idProducto').val();
        //alert(prodcutoID);
        $(".cont-detalleView").load("../destacados/Cdestacados/detalleProducto2/"+prodcutoID);

    });

    $(".viewDetalle4").click(function()
    {
        $(".myModalDetalle2").modal({
           backdrop: 'static', 
           keyboard: false 
        ...
        var prodcutoID = $(this).find('.idProducto').val();
        //alert(prodcutoID);
        $(".cont-detalleView").load("../destacados/Cdestacados/detalleProducto4/"+prodcutoID);
...
<ul class="nav nav-tabs">
   <li id="menu_li" class="A active"><a href="#tab1_1" data-toggle="tab"><i class='fa fa-eye'></i>Destacados</a></li>
  <li id="menu_li" class="C "><a href="#tab1_3" data-toggle="tab"><i class='fa fa-home'></i>Slide Images</a></li>
  <li id="menu_li" class="D "><a href="#tab1_4" data-toggle="tab"><i class='fa fa-list-ul'></i>Eventos</a></li>  
</ul>
                            ...
                            foreach ($producto as $value) {
                                    ?>
                                     <tr>
                                        ...
                                        <td><?php if($value->tipo){ echo "Destacado"; }   ?></td>
                            ...
                            foreach ($eventos as $value) {
                                    ?>
                                     <tr>
                                        ...
                                        <td>
                                                    <a class="btn btn-primary  btn-sm viewDetalle4" style="margin-left: -9px;" role="button">Detalle
                                                    <input type="hidden" name="idProducto" class="idProducto" value="<?php echo $value->id_producto ?>"></a>
