  ...
  $(document).ready(function(){
    $("#delete").click(function()
    {
        var formulario = $(this).attr('name');
            ...
            $.ajax({
               url: "../destacados/Cdestacados/delete_destacado/"+formulario,
                type:"get",
    ...
    $(".saveProducto").click(function()
    {
        var formulario = $(this).attr('name');
            ...
            $.ajax({
               url: "../destacados/Cdestacados/save_destacado/"+formulario,
                type:"get",
...
<div class="cont-table-detalle">
  ...
  </div> <a href="#" name="<?php echo $detalle[0]->id_producto; ?>" class="saveProducto btn btn-success" style="float: right;">Guardar</a>
</div>
