...
class Cdestacados extends CI_Controller {
	...
	function __construct()
	{
		...
		$this->load->model('backend/destacados/productos_model');	
	}

	public function index()
	{		
		$data['eventos'] = $this->productos_model->categoria();
		...
		$this->load->view('backend/destacados/VproductosAdd.php',$data);
	}
	...
	public function delete_destacado($id)
	{

		 $this->productos_model->delete_destacado($id);
	}

	public function save_destacado($id)
	{

		 $this->productos_model->save_destacado($id);
	}

	public function delete_destacado4($id)
	{

		 $this->productos_model->delete_destacado($id);
	}

	public function save_destacado4($id,$image)
	{

		 $this->productos_model->save_destacado_evento( $id, $image);
	}
...
// Detalle del producto
	...
	{	
		...
		$this->load->view('backend/destacados/datelleProducto2.php',$data);

	}

	public function detalleProducto4($productoID)
	{	
		$data['productoID'] = $productoID;
		//$data['detalle'] = $this->productos_model->getDetalle($productoID);
		//$data['ingredienteC'] = $this->productos_model->getStatusIngrediente($productoID);
		...
		$this->load->view('backend/destacados/datelleProducto4.php',$data);
