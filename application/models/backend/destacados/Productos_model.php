...
class productos_model extends CI_Model
{
    ...
    public function categoria()
    {
        ...
        $this->db->join(self::destacados,' on '. 
                        self::destacados.'.id_p = '.
                        self::producto.'.id_producto', 'left');
    ...
    public function delete_destacado($id){
        ...
        $this->db->delete(self::destacados,$data);
    ...
    public function save_destacado($id){
        ...
        $this->db->insert(self::destacados,$data);

    }

    public function save_destacado_evento($id , $image ){
