...
class caja_model extends CI_Model
{
    ...
    public function getPedidosDespachoBySucursal($id_sucursal)
    {
        ...
        sp.fechahora_pedido, sp.fecha_creado, pd.id_detalle, pd.id_producto, pd.precio_grabado, pd.precio_original, GROUP_CONCAT(pd.id_producto,"_",p.nombre_producto) as name_producto, GROUP_CONCAT(p.nombre_producto) as name_productos, u.nombres, u.apellidos, sp.id_sucursal, SUM(pd.precio_original) as totalSin, si.monto_impuesto
          from sys_pedido sp
